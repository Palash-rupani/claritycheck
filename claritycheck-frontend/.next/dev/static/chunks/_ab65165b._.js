...
function analyzeProduct(product, followups) {
    ...
    // --------------------------------------------------------
    const overall = Math.round(ingredientSafety * 0.35 + claimCredibility * 0.15 + traceability * 0.25 + completeness * 0.25);
    // --------------------------------------------------------
...
function ReportPage() {
    ...
    const loadData = async ()=>{
        try {
            ...
            const questionsList = Array.isArray(questionData) ? questionData : questionData.followups || questionData.data || [];
            setQuestions(questionsList);
            // 🟢 Run analysis
            const analysisResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reportEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzeProduct"])(productData, questionsList);
            setAnalysis(analysisResult);
        } catch (err) {
            setError(err.message || 'Failed to load report data. Ensure backend is running at http://localhost:8000');
        } finally{
            setLoading(false);
        }
    };
    ...
    const handleDownloadPDF = async ()=>{
      ...
      `;
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html2pdf$2e$js$2f$dist$2f$html2pdf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])().set(opt).from(reportRef.current).save();
            // Clean up override
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Your product transparency analysis is ready"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/ReportPreview.tsx",
                                    lineNumber: 189,
                                    columnNumber: 13
...
function ReportPage() {
    ...
    // ✅ ONLY fetch product — NO followups (backend doesn’t support it)
    const loadData = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const productData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProduct"])(productId);
            setProduct(productData);
            // ❗Since followups endpoint does NOT exist, use empty list
            const answers = [];
            // 💡 Run analysis on product + empty answers list
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reportEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzeProduct"])(productData, answers);
            setAnalysis(result);
        } catch (err) {
            setError(err.message || 'Failed to load report data. Ensure backend is running at http://localhost:8000');
        } finally{
    ...
    // ✅ Generate PDF from the whole report section
    const handleDownloadPDF = async ()=>{
        if (!reportRef.current || !product) return;
        setDownloading(true);
        setError(null);
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "font-medium text-foreground",
                                                    children: "Transparency Assessment"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/products/[id]/report/page.tsx",
                                                    lineNumber: 196,
                                                    columnNumber: 17
...
_s(ReportPage, "4HMZ2SDmJpgf9DJ3atiHk/0OhTA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=_ab65165b._.js.map